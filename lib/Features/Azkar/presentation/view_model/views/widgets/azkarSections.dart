final List<Map<String, dynamic>> azkarSections = const [
  ...
  },
  {
    ...
    'data': [
      ...
      {
        'text': 'بِسْمِ اللَّهِ اللَّهُمَّ رَبَّ النَّاسِ أَذْهِبِ البَاسَ، اشْفِ أَنْتَ الشَّافِي، لا شِفَاءَ إِلَّا شِفَاؤُكَ، شِفَاءً لا يُغَادِرُ سَقَمًا.',
        'count': '1',
        'reference': 'القرآن والسنة'
      },
      {
        'text': 'قُلْ أَعُوذُ بِرَبِّ الْفَلَقِ وَقُلْ أَعُوذُ بِرَبِّ النَّاسِ، وَقُلْ أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ كُلِّ شَيْءٍ يَؤْذِينِي.',
        'count': '1',
        'reference': 'صحيح مسلم'
      },
    ],
